...
const PrivacyPolicyPage: React.FC = () => (
  <div className="prose mx-auto w-full max-w-3xl flex-col px-6 py-16 dark:prose-invert">
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to Lahilo, the
      ...
      <li>
        <p>
          ...
          Agreement) refers to Lahilo.
        </p>
      </li>
      <li>
        <p>
          <strong>Country</strong> refers to: Minnesota,
          United States
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          to facilitate the Service, to provide the Service
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          forms of electronic communication, such as a
    ...
    <p>
      ...
      for a shorter period of time, except when this data is
    ...
    <p>
      ...
      may also contact Us to request access to, correct, or
      delete any personal information that You have provided
      to Us.
    </p>
    <p>
      Please note, however, that We may need to retain
      certain information when we have a legal obligation or
    ...
    <ul>
      <li>
        <p>By email: jacob.samps@gmail</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:{' '}
          <a
            href="https://aprovan.com/privacy-policy"
            rel="external nofollow noopener"
          >
            https://aprovan.com/privacy-policy
          </a>
        </p>
      </li>
    </ul>
